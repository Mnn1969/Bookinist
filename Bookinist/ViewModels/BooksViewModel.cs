...
namespace Bookinist.ViewModels
{
    class BooksViewModel : ViewModel
    {
        ...
        private string _BooksFilter = null!;
        ...
        public ICommand LoadDataCommand => _LoadDataCommand
            ??= new Infrastructure.Commands.LambdaCommandAsync(OnLoadDataCommandExecuted, CanLoadDataCommandExecute);
        ...
        public ICommand AddNewBookCommand => _AddNewBookCommand
            ??= new Infrastructure.Commands.LambdaCommand(OnAddNewBookCommandExecuted, CanAddNewBookCommandExecute);
